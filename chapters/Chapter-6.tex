...
\end{equation}
Figure \ref{fig:chap6-cavity-mode-lines} depicts the relationship between the cavity resonant modes and the cavity length for a cylindrical cavity with a fixed radius.
