...
\begin{equation}
    \tau_\lambda\Delta f_c=\frac{1}{2\pi}\implies\Delta\omega_c=\frac{1}{2\pi\tau_\lambda}.
\end{equation}
...
\begin{figure}[htbp]
    ...
    \caption{\label{fig:chap3-bathtub-trap}}
\end{figure}
...
\end{figure}
The dominant component, with the highest frequency, is the electron's cyclotron 
