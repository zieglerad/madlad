...
In Figure \ref{fig:phase-error-curve-comp} we plot comparisons of the phase error, which is the difference between measurement and model, for the synthetic array data and the FSCD array data as a function of the radial position of the SYNCA. The FSCD array data is referred to as the JUGAAD data in the plot legend, which was an alternative name for the FSCD array setup.
\begin{figure}[htbp]
    \centering
