...
Additionally, tritium beta-decay is a super-allowed decay, which results in a relatively short half-life of 12.3~years. Therefore, it is relatively easy to obtain a high-activity using a small source mass. High-activity is desirable because of the low-activity near the tritium spectrum endpoint. For tritium beta-decays only a factor of $3\times10^{-13}$ of the decays occur in the last 1~eV of the spectrum. Isotopes with Q-values lower than tritium are known \cite{FORMAGGIO20211}, but this is outweighed by exceedingly long half-lives leading to unobtainable source masses.
